...
{
    public class MakeUnprocessableOrderMock : IMakeOrderMockCreator
    {
        #region Fields
        ...
        {
            new ExtendedEntity<Product>(EntityStatus.UnprocessableUpdate, 
                new Product()
                {
                    Sku = testSkus[0],
                    Price = testPrices[0],
        ...
        public OrderDetails ExpectedOrderDetailsResult => new OrderDetails()
        {
            ...
            ProductsDetails = new List<OrderedProductDetails>()
            {
                new OrderedProductDetails()
                {
                    ...
                    Price = testPrices[0],
                    UnitWeight = testUnitWeights[0],
                    Status = EntityStatus.UnprocessableUpdate,
                    Currency = testCurrency
                }
            }
        };
